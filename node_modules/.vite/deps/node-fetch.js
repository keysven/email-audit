...
var require_punycode = __commonJS({
  "browser-external:punycode"(exports, module) {
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn(`Module "punycode" has been externalized for browser compatibility. Cannot access "punycode.${key}" in client code. See https://vitejs.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
        }
      }
    }));
  }
...
var require_iconv_loader = __commonJS({
  "node_modules/encoding/lib/iconv-loader.js"(exports, module) {
    ...
    try {
      iconv_package = "iconv";
      Iconv = __require(iconv_package).Iconv;
    } catch (E) {
    }
...
var require_encoding = __commonJS({
  "node_modules/encoding/lib/encoding.js"(exports, module) {
    ...
    function convert2(str, to, from, useLite) {
...
var URL = import_url.default.URL || import_whatwg_url.default.URL;
